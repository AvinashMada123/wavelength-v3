...
class BotConfig(Base):
    ...
    tts_provider: Mapped[str] = mapped_column(Text, nullable=False, server_default="sarvam")
    tts_voice: Mapped[str] = mapped_column(Text, nullable=False, server_default="priya")
