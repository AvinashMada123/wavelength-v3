...
async def build_pipeline(
    ...
    # Set tools in Google-native format directly on context
    # (OpenAI format fails: GoogleLLMService passes context.tools as-is to Google SDK)
    context.tools = [_build_end_call_tool()]
